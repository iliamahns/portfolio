...
export default function HolographicButton({ href, text, imagePath, size = 'lg' }: HolographicButtonProps) {
  ...
  return (
    <Link href={href} className="group relative">
      <div className={`${dimensions} rounded-full overflow-hidden cursor-pointer hover:scale-105 hover:shadow-lg hover:opacity-80 ease-linear transition-transform relative`}>
